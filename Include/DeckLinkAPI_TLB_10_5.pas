...
// $Rev: 52393 $
// File generated on 16.09.2015 15:27:32 from Type Library described below.
...
const
  ...
  IID_IDeckLinkEncoderConfiguration: TGUID = '{67455668-0848-45DF-8D8E-350A77C9A028}';
  ...
  IID_IDeckLinkEncodedData: TGUID = '{2C0F1624-0D33-409F-9162-A0C331A25C3D}';
  IID_IDeckLinkEncoderPacket: TGUID = '{A2CFDD65-B851-4E96-999A-AE1CDD620DA7}';
  IID_IDeckLinkEncoderAudioPacket: TGUID = '{2D4CCC33-BFE3-4976-83FC-88A60410836B}';
  ...
  IID_IDeckLinkH265NALPacket: TGUID = '{9ED7B3C9-3AA8-4524-8F9E-9C139D3975AA}';
...
// *********************************************************************//
  ...
  IDeckLinkEncodedData = interface;
...
// *********************************************************************//
  IDeckLinkEncoderInputCallback = interface(IUnknown)
    ...
    function VideoInputSignalChanged(notificationEvents: _BMDVideoInputFormatChangedEvents; 
                                     const newDisplayMode: IDeckLinkDisplayMode; 
                                     detectedSignalFlags: _BMDDetectedVideoInputFormatFlags): HResult; stdcall;
    function VideoEncoderPacketArrived(const encoderPacket: IDeckLinkEncoderPacket): HResult; stdcall;
    function VideoEncoderAudioPacketArrived(const audioPacket: IDeckLinkEncoderAudioPacket): HResult; stdcall;
  end;

// *********************************************************************//
// Interface: IDeckLinkEncodedData
// Flags:     (0)
// GUID:      {2C0F1624-0D33-409F-9162-A0C331A25C3D}
// *********************************************************************//
  IDeckLinkEncodedData = interface(IUnknown)
    ['{2C0F1624-0D33-409F-9162-A0C331A25C3D}']
    function GetBytes(out buffer: Pointer): HResult; stdcall;
...
// Flags:     (0)
// GUID:      {A2CFDD65-B851-4E96-999A-AE1CDD620DA7}
// *********************************************************************//
  IDeckLinkEncoderPacket = interface(IDeckLinkEncodedData)
    ['{A2CFDD65-B851-4E96-999A-AE1CDD620DA7}']
    function GetPixelFormat: _BMDPixelFormat; stdcall;
    function GetStreamTime(out frameTime: Int64; out frameDuration: Int64; timeScale: Int64): HResult; stdcall;
    function GetHardwareReferenceTimestamp(timeScale: Int64; out frameTime: Int64; 
                                           out frameDuration: Int64): HResult; stdcall;
    function GetTimecode(format: _BMDTimecodeFormat; out timecode: IDeckLinkTimecode): HResult; stdcall;
    function IsMetadataPacket: Integer; stdcall;
  end;

// *********************************************************************//
// Interface: IDeckLinkEncoderAudioPacket
// Flags:     (0)
// GUID:      {2D4CCC33-BFE3-4976-83FC-88A60410836B}
// *********************************************************************//
  IDeckLinkEncoderAudioPacket = interface(IDeckLinkEncodedData)
    ['{2D4CCC33-BFE3-4976-83FC-88A60410836B}']
    function GetStreamTime(out packetTime: Int64; timeScale: Int64): HResult; stdcall;
...
// Flags:     (0)
// GUID:      {9ED7B3C9-3AA8-4524-8F9E-9C139D3975AA}
// *********************************************************************//
  IDeckLinkH265NALPacket = interface(IUnknown)
    ['{9ED7B3C9-3AA8-4524-8F9E-9C139D3975AA}']
...
// *********************************************************************//
  IDeckLinkStatus = interface(IUnknown)
    ...
    function GetBytes(statusID: _BMDDeckLinkStatusID; out buffer: Pointer; out bufferSize: SYSUINT): HResult; stdcall;
  end;
