...
const
  ...
  gKnownPixelFormatNames: array[0..9] of string	= ('8-bit YUV', '10-bit YUV', '8-bit ARGB', '8-bit BGRA', '10-bit RGB', '12-bit RGB', '12-bit RGBLE', '10-bit RGBXLE', '10-bit RGBX', 'NULL');
  ...
  begin
    ...
    if (result = S_OK) then
      ...
      begin
        ...
        begin
          write(format('%s'+#09,[gKnownPixelFormatNames[pixelFormatIndex]]));
        end else
          write('------'+#09+#09);
